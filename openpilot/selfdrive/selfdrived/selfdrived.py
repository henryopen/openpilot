...
class SelfdriveD(CruiseHelper):
  ...
  def update_events(self, CS):
    ...
    if CS.canValid:
      ...
      # safety, so releasing it resumes without a SET/RES press.
      if (CS.gasPressed and not self.CS_prev.gasPressed and self.disengage_on_accelerator) or \
        (CS.brakePressed and not brake_is_override(self.CP, CS) and (not self.CS_prev.brakePressed or not CS.standstill)) or \
