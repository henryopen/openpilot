"""Start the lane change on the blinker alone, once the blind spot has been clear long enough.

Ported from sunnypilot, whose behaviour this car was set up with. The timings and the
rule that an occupied blind spot restarts the whole wait are theirs, unchanged.
"""
